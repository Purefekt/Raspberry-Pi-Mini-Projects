...
if video_path is None:
    vs = VideoStream().start() # warm up the camera time.sleep(2)
else:
...
while True:
    ...
    gray = cv2.cvtColor(frame, cv2.COLOR_BGR2GRAY) #smooting image in 21x21 pixels regions
...
vs.stop() 
# if video_path is None: pass else vs.release() 
